        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                      ...
                      <li><a href="{{ url('/recipe/create') }}">Nuova ricetta</a></li>
            <li>
                  {!! Form::open(['route' => 'search','class'=>'navbar-form navbar-left']) !!} 
                    <div class="form-group">
                        {!! Form::input('text','search',null,['placeholder'=>'Search','class' => 'form-control']) !!}
                    </div>
                    {!! Form::submit('Cerca', ['class' => 'btn btn-default']) !!}
                  {!! Form::close() !!}
